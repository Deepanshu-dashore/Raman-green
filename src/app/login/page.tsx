  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full bg-white rounded-[32px] border border-gray-100 p-8 md:p-10 shadow-[0_20px_50px_rgba(27,48,34,0.04)]">
        ...
        <p className="text-xs text-gray-400 font-semibold text-center leading-relaxed mb-8">
          Sign in to your account to continue shopping the goodness of nature.
        </p>
          ...
          <div>
            ...
            <div className="relative flex items-center group">
              ...
              <input
                ...
                required
                className="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:bg-white focus:border-forest focus:ring-4 focus:ring-forest/5 outline-none transition-all text-sm font-semibold text-gray-900 placeholder:text-gray-400"
          ...
          <div>
            ...
            <div className="relative flex items-center group">
              ...
              <input
                ...
                required
                className="w-full pl-11 pr-11 py-3 bg-white border border-gray-200 rounded-xl focus:bg-white focus:border-forest focus:ring-4 focus:ring-forest/5 outline-none transition-all text-sm font-semibold text-gray-900 placeholder:text-gray-400"
        ...
        <div className="mt-6 p-3 bg-green-50/50 border border-green-100/50 rounded-2xl flex items-start gap-2.5">
          <Icon icon="solar:shield-check-bold-duotone" className="w-5 h-5 text-[#47C269] shrink-0 mt-0.5" />
          <div className="text-[10px] text-gray-600 font-semibold leading-relaxed">
            <p className="font-bold text-forest">100% Secure Login</p>
            <p className="text-gray-400/80">Your data is safe with us. We never share your information.</p>
          </div>
        </div>
      </div>
